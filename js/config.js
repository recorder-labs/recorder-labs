...
const QUIZ_TYPE_DESC = {
  ALL: '모든 유형의 문제가 골고루 섞여서 출제됩니다.',
  A:   '계이름을 보고 리코더 구멍을 직접 클릭해서 운지법을 만들어 보세요.',
  B:   '계이름에 맞는 올바른 운지법 그림을 4개 중에서 골라보세요.',
  C:   '오선지 위 음표를 보고 어떤 계이름인지 읽어보세요.',
  D:   '계이름을 보고 오선지 위 음표가 있는 위치를 클릭해 보세요.',
  E:   '운지법 그림 중 딱 하나 잘못된 구멍을 찾아 클릭하세요!',
};

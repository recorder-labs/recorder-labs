...
function showQuizEnd() {
  ...
  else if (pct >= 0.7) { emoji='😀'; title='아주 잘했어요~ 훌륭해요💚';      msg='대부분 정답이에요. 한 번만 더 풀면 훨씬 잘할 수 있어요!'; }
...
const _A_CORRECT_TEXTS_DO = [
  ...
  '〈{L}〉 손가락이 모든 구멍에 정확히 닿았어요! 좋은 손 감각이에요.',
  '〈{L}〉 운지를 또렷이 알고 있네요! 손가락이 한 자리도 빠짐없이 자리를 잡았어요.',
  '〈{L}〉 음의 손 모양을 단숨에 잡았어요! 모든 구멍을 닫는 자세가 안정적이에요.',
  '〈{L}〉 운지를 정확히 익혔어요! 양손이 빈틈없이 잘 맞춰지고 있어요.',
  '〈{L}〉의 가장 낮은 음 운지가 익숙해 보여요! 손가락 힘도 잘 나눠졌어요.',
